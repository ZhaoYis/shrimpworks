...
export type AgentType = 'PROJECT_MANAGER' | 'PRODUCT_MANAGER' | 'SCRUM_MASTER' | 'ARCHITECT' | 'FRONTEND_DEVELOPER' | 'BACKEND_DEVELOPER' | 'FULL_STACK_DEVELOPER' | 'DEVOPS_ENGINEER' | 'QA_ENGINEER' | 'DATA_ENGINEER' | 'DATA_SCIENTIST' | 'AI_ML_ENGINEER' | 'UI_UX_DESIGNER' | 'TECHNICAL_WRITER' | 'SECURITY_ENGINEER' | 'SRE' | 'CODE_REVIEWER' | 'PROMPT_ENGINEER';
